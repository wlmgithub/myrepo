...
var pathToImages = '/lwang/images/';	// Relative to your HTML file
...
//	alert('returnDateToMonth = ' + returnDateToMonth);

       	var testDate = new Date();
        testDate.setDate(returnDateToDay.value);
        testDate.setMonth(currentMonth);
        testDate.setYear(currentYear);
        currentDayOfWeek = dayArray[testDate.getDay()];
//	alert('currentDayOfWeek = ' + currentDayOfWeek);

	returnDateToDayOfWeek.value = currentDayOfWeek;

/*
		for(var no=0;no<returnDateToDayOfWeek.options.length;no++){
			if(returnDateToDayOfWeek.options[no].value==parseFloat(currentDayOfWeek)) {
				returnDateToDayOfWeek.selectedIndex=no;
				break;
			}
		}
*/
...
function displayCalendarSelectBox(yearInput,monthInput,dayInput,hourInput,minuteInput,dayOfWeekInput,buttonObj)
{
	...
	returnDateToMinute = minuteInput;
        returnDateToDayOfWeek = dayOfWeekInput;

//	alert('returnDateToDayOfWeek.value = ' + returnDateToDayOfWeek.value);
